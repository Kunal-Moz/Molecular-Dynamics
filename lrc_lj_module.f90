...
CONTAINS
  ...
  FUNCTION potential_lrc ( density, r_cut )
    IMPLICIT NONE
    REAL*8                :: potential_lrc ! Returns long-range correction to potential/atom
    REAL*8,    INTENT(in) :: density       ! Number density N/V
    REAL*8,    INTENT(in) :: r_cut         ! Cutoff distance
  ...
  FUNCTION pressure_lrc ( density, r_cut )
    IMPLICIT NONE
    REAL*8                :: pressure_lrc ! Returns long-range correction to pressure
    REAL*8,    INTENT(in) :: density      ! Number density N/V
    REAL*8,    INTENT(in) :: r_cut        ! Cutoff distance
  ...
  FUNCTION pressure_delta ( density, r_cut )
    IMPLICIT NONE
    REAL*8                :: pressure_delta ! Returns delta correction to pressure
    REAL*8,    INTENT(in) :: density        ! Number density N/V
    REAL*8,    INTENT(in) :: r_cut          ! Cutoff distance
